    ...
    <div className="space-y-8">
      ...
      <div className="relative">
         ...
         <input 
           ...
           value={localSearch || ''}
           onChange={(e) => setLocalSearch && setLocalSearch(e.target.value)}
           className="w-full pl-9 pr-8 py-2.5 bg-gray-50 border border-transparent rounded-xl text-xs focus:bg-white focus:border-primary/20 outline-none transition-all placeholder:text-gray-300 text-secondary font-bold"
         />
         {localSearch && (
           <button
             onClick={() => setLocalSearch && setLocalSearch('')}
