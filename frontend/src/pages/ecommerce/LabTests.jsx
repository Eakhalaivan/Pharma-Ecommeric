...
export default function LabTests() {
  return (
    <div className="bg-gray-50/30 min-h-screen">
      {/* Hero Section */}
      <div className="bg-[#0f172a] text-white py-12 lg:py-20 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {popularPackages.map((pkg, i) => (
              ...
              >
                ...
                <button className="w-full bg-[#0f172a] text-white py-4 rounded-xl font-black uppercase tracking-[0.2em] text-[10px] hover:bg-primary transition-colors shadow-lg shadow-[#0f172a]/10">
                  Book Now
                </button>
              </motion.div>
            ))}
